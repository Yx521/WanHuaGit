...
import com.example.lenovo.playandroid.module.wx.ModuleShou;
...
public class PresenterShou<V extends IView> extends IBasePresenter<V> implements ModuleShou.FishCallBase {
    private  ModuleShou wxmodule=new ModuleShou();
